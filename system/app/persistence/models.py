...
class FollowedSource(Base, TimestampMixin):
    ...
    profile_job_id: Mapped[str | None] = mapped_column(String(255), index=True)
    suggested_conviction: Mapped[str | None] = mapped_column(String(32))
    profile_summary_json: Mapped[dict | None] = mapped_column(JSON)
    status: Mapped[str] = mapped_column(String(32), default="pending", index=True)
    last_profile_requested_at: Mapped[datetime | None] = mapped_column(DateTime)
